...
# Analysis object: /ATLAS_2017_I1514251/d32-x01-y01
...
ax_xLabel = r'$\Delta\phi$(leading, second jet)'
ax_yLabel = r'd$\sigma/$d$\Delta\phi$ [pb]'
...
exec(open(prefix+'d32-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd32-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd32-x01-y01.png'), format='PNG')
