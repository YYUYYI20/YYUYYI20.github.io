...
# Analysis object: /ATLAS_2017_I1514251/d35-x01-y01
# Timestamp: 19-09-2024 (11:14:54)
...
ax_xLabel = r'$M$(leading, second jet) [GeV]'
ax_yLabel = r'd$\sigma/$d$M$ [pb/GeV]'
...
exec(open(prefix+'d35-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd35-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd35-x01-y01.png'), format='PNG')
